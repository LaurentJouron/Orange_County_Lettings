...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\coverage\execfile.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.coverage.execfile.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.coverage.execfile.source.html#l31">
                  <tt><i>31</i> <span class="k">class</span> <span class="nc">DummyLoader</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>

...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\coverage\tomlconfig.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.coverage.tomlconfig.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.coverage.tomlconfig.source.html#l34">
                  <tt><i>34</i> <span class="k">class</span> <span class="nc">TomlConfigParser</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>

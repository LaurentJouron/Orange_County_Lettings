...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\coverage\collector.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.coverage.collector.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.coverage.collector.source.html#l379">
                  <tt><i>379</i>         <span class="k">except</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>

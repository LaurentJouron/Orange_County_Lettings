...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\coverage\jsonreport.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.coverage.jsonreport.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.coverage.jsonreport.source.html#l28">
                  <tt><i>28</i> <span class="k">class</span> <span class="nc">JsonReporter</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>

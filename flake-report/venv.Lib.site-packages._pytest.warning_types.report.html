      ...
      <div id="page">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages._pytest.warning_types.source.html#l170">
                  <tt><i>170</i>         <span class="c1"># If warnings are errors (e.g. -Werror), location information gets lost, so we add it to the message.</span></tt>
               </a>
            </li>
            </ul>
         </li>

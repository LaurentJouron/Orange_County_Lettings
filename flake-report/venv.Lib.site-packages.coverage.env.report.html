...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\coverage\env.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.coverage.env.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.coverage.env.source.html#l40">
                  <tt><i>40</i> <span class="k">class</span> <span class="nc">PYBEHAVIOR</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
